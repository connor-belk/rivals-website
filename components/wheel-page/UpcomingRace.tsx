export default function UpcomingRace() {
  return (
    <div className="text-slate-200 h-[50vh] min-h-72 md:h-[40vh] m-2 bg-slate-500 rounded-3xl relative">
      ...
      <div className="absolute w-full h-full bg-black/50 rounded-3xl">
        <div className="w-full h-full flex flex-col justify-center items-center gap-2">
          <h3 className="text-4xl md:text-5xl font-bold">Upcoming Event</h3>
          <p className="font-bold text-xl md:text-3xl">
            Circuit of Spa-Francorchamps
          </p>
          <p className="font-bold text-xl md:text-2xl">
            Multi-Modal Series Race 4
          </p>
